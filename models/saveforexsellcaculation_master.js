...
const saveforexsellcalculationmasterSchema = new Schema({
   type :  {type: String},
...
module.exports = mongoose.model('saveforexsellcalculation_master',saveforexsellcalculationmasterSchema);
